(function() {
  var ImapConnection, MailParser, cmd, cmds, controllers, fs, get_message, imap, mailparser, next, nodemailer, project_email, project_pw, utils;
  ...
  mailparser.on('end', function(mail) {
    var a, attachment, fname, options, _i, _len, _ref;
    attachment = null;
    _ref = mail.attachments;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      a = _ref[_i];
      if (a.contentType in controllers.accepted_types) attachment = a;
    }
    if (attachment) {
      fname = utils.normedPathJoin(__dirname, '../uploads/', attachment.generatedFileName);
      options = {
