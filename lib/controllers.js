(function() {
  var Journal, Segment, accepted_types, create_categorize_task, create_transcribe_task, dbchecker, dormouse, finalize_journal, fs, join, json_spawn, mongoose, notify_finalized, record_transcription, save_segments_to_db, spawn, split, url, utils;
  ...
  exports.configure = function(server, io) {
